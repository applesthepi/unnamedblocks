...
sf::Vector2f ArgumentBool::LCir(float angle)
{
...
sf::Vector2f ArgumentBool::RCir(float angle)
{
...
BlockArgumentType ArgumentBool::GetType()
{
	return BlockArgumentType::BOOL;
}

uint32_t ArgumentBool::GetWidth()
{
	if (m_mode == BlockArgumentVariableMode::RAW)
...
bool ArgumentBool::HasData()
{
	return true;
}

void ArgumentBool::Select()
{
...
void ArgumentBool::UnSelect()
{
	UIRegistry::GetRegistry().RemoveComponent(&m_field);
}

void ArgumentBool::UpdateVertexArray()
{
	uint16_t height = Global::BlockHeight - Global::BlockBorder;
...
void ArgumentBool::OnRender()
{

}

void ArgumentBool::OnUpdateBuffers()
{

}

void ArgumentBool::OnReloadSwapChain()
{
