...
const glm::vec<4, uint8_t>&& Color::GetU8()
{
	return std::move(glm::vec<4, uint8_t>(static_cast<uint8_t>(m_Color.r * 255.0f), static_cast<uint8_t>(m_Color.g * 255.0f), static_cast<uint8_t>(m_Color.b * 255.0f), static_cast<uint8_t>(m_Color.a * 255.0f)));
}