...
IMGUI_IMPL_API void                 ImGui_ImplVulkanH_DestroySystems(VkInstance instance, VkDevice device, ImGui_ImplVulkanH_Window* wd, const VkAllocationCallbacks* allocator);
