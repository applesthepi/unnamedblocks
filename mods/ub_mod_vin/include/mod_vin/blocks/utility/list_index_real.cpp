#include "BlockUtilityListIndexReal.hpp"

#include <Cappuccino/Registration.hpp>

static void execute_release(cap::mod::block::pass* pass)
{
	pass->get_real(2) = *(f64*)((std::vector<void*>*)pass->CustomGet(pass->get_real(0)))->at(pass->get_real(1));
}
...
static void execute_debug(cap::mod::block::pass* pass)
{
	...
	{
		pass->log_error("failed to index *real* with \"" + std::to_string(pass->get_real(1)) + "\" of a list; index is invalid", cap::mod::block::pass::logger_fatality::BREAK);
		return;
	}

	pass->get_real(2) = *(f64*)list->at(pass->get_real(1));
}
...
const char* BlockUtilityListIndexReal::get_category() const
{
	return CATEGORY_UTILITY;
}

cap::mod::block::block::execution BlockUtilityListIndexReal::pull_execute_debug() const
{
	return execute_debug;
}

cap::mod::block::block::execution BlockUtilityListIndexReal::pull_execute_release() const
{
	return execute_release;
}

std::vector<cap::mod::block::block::argument::initializer> BlockUtilityListIndexReal::get_arguments() const
{
