...
{
	pass->get_bool(2) = *(bool*)((std::vector<void*>*)pass->CustomGet(pass->get_real(0)))->at(pass->get_real(1));
}
...
static void execute_debug(cap::mod::block::pass* pass)
{
	...
	{
		pass->log_error("failed to index *bool* with \"" + std::to_string(pass->get_real(1)) + "\" of a list; index is invalid", cap::mod::block::pass::logger_fatality::BREAK);
		return;
	}

	pass->get_bool(2) = *(bool*)list->at(pass->get_real(1));
}
...
const char* BlockUtilityListIndexBool::get_category() const
{
	return CATEGORY_UTILITY;
}

cap::mod::block::block::execution BlockUtilityListIndexBool::pull_execute_debug() const
{
	return execute_debug;
}

cap::mod::block::block::execution BlockUtilityListIndexBool::pull_execute_release() const
{
	return execute_release;
}

std::vector<cap::mod::block::block::argument::initializer> BlockUtilityListIndexBool::get_arguments() const
{
