...
std::vector<cap::mod::block::block::argument::initializer> BlockUtilityThreadKill::get_arguments() const
{
	...
	{ cap::mod::block::block::argument::type::REAL, cap::mod::block::block::argument::variable_mode_restriction::ONLY_VAR, cap::mod::block::block::argument::variable_mode::VAR, "thread"));
