...
const char* mod_vin::block::boolean::set::get_unlocalized_name() const
{
	return "vin_boolean_set";
}

const char* mod_vin::block::boolean::set::get_category() const
{
	return CATEGORY_BOOLEANS;
}

cap::mod::block::block::execution mod_vin::block::boolean::set::pull_execute_release() const
{
	return execute_release;
}

cap::mod::block::block::execution mod_vin::block::boolean::set::pull_execute_debug() const
{
	return execute_debug;
}

std::vector<cap::mod::block::block::argument::initializer> mod_vin::block::boolean::set::get_arguments() const
{
	return {
