...
const char* mod_vin::block::real::divide::get_unlocalized_name() const
{
	return "vin_real_divide";
}

const char* mod_vin::block::real::divide::get_category() const
{
	return CATEGORY_REALS;
}

cap::mod::block::block::execution mod_vin::block::real::divide::pull_execute_release() const
{
	return execute_release;
}

cap::mod::block::block::execution mod_vin::block::real::divide::pull_execute_debug() const
{
	return execute_debug;
}

std::vector<cap::mod::block::block::argument::initializer> mod_vin::block::real::divide::get_arguments() const
{
	return {
