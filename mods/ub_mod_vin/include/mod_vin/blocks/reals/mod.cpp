...
const char* mod_vin::block::real::mod::get_unlocalized_name() const
{
	return "vin_real_mod";
}

const char* mod_vin::block::real::mod::get_category() const
{
	return CATEGORY_REALS;
}

cap::mod::block::block::execution mod_vin::block::real::mod::pull_execute_release() const
{
	return execute_release;
}

cap::mod::block::block::execution mod_vin::block::real::mod::pull_execute_debug() const
{
	return execute_debug;
}

std::vector<cap::mod::block::block::argument::initializer> mod_vin::block::real::mod::get_arguments() const
{
	return {
