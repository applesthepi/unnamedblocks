...
const char* mod_vin::block::real::minus::get_unlocalized_name() const
{
	return "vin_real_minus";
}

const char* mod_vin::block::real::minus::get_category() const
{
	return CATEGORY_REALS;
}

cap::mod::block::block::execution mod_vin::block::real::minus::pull_execute_release() const
{
	return execute_release;
}

cap::mod::block::block::execution mod_vin::block::real::minus::pull_execute_debug() const
{
	return execute_debug;
}

std::vector<cap::mod::block::block::argument::initializer> mod_vin::block::real::minus::get_arguments() const
{
	return {
