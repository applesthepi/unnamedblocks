...
const char* mod_vin::block::real::comp_gr::get_unlocalized_name() const
{
	return "vin_real_comp_gr";
}

const char* mod_vin::block::real::comp_gr::get_category() const
{
	return CATEGORY_REALS;
}

cap::mod::block::block::execution mod_vin::block::real::comp_gr::pull_execute_release() const
{
	return execute_release;
}

cap::mod::block::block::execution mod_vin::block::real::comp_gr::pull_execute_debug() const
{
	return execute_debug;
}

std::vector<cap::mod::block::block::argument::initializer> mod_vin::block::real::comp_gr::get_arguments() const
{
	return {
