...
public:
	...
	{
	public:
		block_argument_caller(const espresso::mod::block::block::argument::variable_mode mode, const std::string& value)
			: m_mode(mode)
			, m_value(value)
		{}
	...
	struct block_info
	{
		espresso::mod::block::block* block_mod_block;
	...
	///
	void register_block(espresso::mod::block::block* block, const std::string& mod_unlocalized_name);
