...
espresso::mod::block::block::argument::type rhr::stack::argument::real::get_type()
{
	return espresso::mod::block::block::argument::type::REAL;
}
...
void rhr::stack::argument::real::on_set_mode(espresso::mod::block::block::argument::variable_mode mode)
{
	if (m_mode == espresso::mod::block::block::argument::variable_mode::RAW)
