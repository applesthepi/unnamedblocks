...
const std::vector<BlockArgumentInitializer> BlockGraphicsSpriteTextureSet::GetArguments() const
{
	...
	args.push_back(BlockArgumentInitializer(BlockArgumentType::TEXT, BlockArgumentVariableModeRestriction::NONE, BlockArgumentVariableMode::RAW, "sprite set texture"));
