...
espresso::mod::block::pass::initializer::initializer(
	std::vector<f64*>& t_real, std::vector<bool*>& t_bool, std::vector<std::string*>& t_string
)
	: template_real(t_real)
	, template_bool(t_bool)
...
espresso::mod::block::pass::pass(const initializer& init)
{
	if (init.debug_mode)
	{
	...
	for (u64 i = 0; i < init.function_total_count; i++)
	{
		void*** stack = new void**[init.function_call_count[i]];
		std::vector<u64> sizes;

		for (u64 a = 0; a < init.function_call_count[i]; a++)
		{
	...
	for (u64 i = 0; i < init.function_total_count; i++)
	{
		u64** stack = new u64*[init.function_call_count[i]];
	...
	const std::vector<f64*>& real_template			 = init.template_real;
	const std::vector<bool*>& bool_template			 = init.template_bool;
	const std::vector<std::string*>& string_template = init.template_string;
...
void espresso::mod::block::pass::set_data(espresso::mod::block::data** data)
{
	m_data = data;
}

void espresso::mod::block::pass::set_callstack_stack(std::vector<u64>* callstack)
{
	m_callstack_stack_idx = callstack;
}

void espresso::mod::block::pass::set_callstack_block(std::vector<u64>* callstack)
{
	m_callstack_block_idx = callstack;
}

void espresso::mod::block::pass::set_successful(bool* successful)
{
	m_successful = successful;
}

void espresso::mod::block::pass::set_finished(std::atomic<bool>* finished)
{
	m_finished = finished;
}

void espresso::mod::block::pass::set_callstack_local(void (***local_callstack)(pass*))
{
	m_local_callstack = local_callstack;
}

void espresso::mod::block::pass::set_calls(void (***calls)(pass*))
{
	m_calls = calls;
}

void espresso::mod::block::pass::perform_deallocation_callbacks()
{
...
std::chrono::steady_clock::time_point* espresso::mod::block::pass::get_begin_time()
{
	return m_begin_time;
}

void espresso::mod::block::pass::stop()
{
	m_stop();
...
void espresso::mod::block::pass::add_callstack(u64 stack, u64 block, bool special)
{
...
void espresso::mod::block::pass::pop_callstack()
{
...
void espresso::mod::block::pass::set_stack_idx(u64 idx)
{
	if (m_callstack_stack_idx->size() > 0)
...
void espresso::mod::block::pass::set_block_idx(u64 idx)
{
	if (m_callstack_block_idx->size() > 0)
		m_callstack_block_idx->back() = idx;
}

std::mt19937_64& espresso::mod::block::pass::get_random_generator()
{
	return m_random;
}

void espresso::mod::block::pass::add_deallocation(std::function<void(espresso::mod::block::pass*)>* dealloc)
{
	m_deallocation_calls.push_back(dealloc);
}

void espresso::mod::block::pass::remove_deallocation(std::function<void(espresso::mod::block::pass*)>* dealloc)
{
	for (u64 i = 0; i < m_deallocation_calls.size(); i++)
	{
...
u64 espresso::mod::block::pass::custom_put(void* mem)
{
...
void* espresso::mod::block::pass::custom_get(u64 idx)
{
	// TODO change to shared
	std::unique_lock<std::mutex> lock(*m_custom_registrer_mutex);
...
void espresso::mod::block::pass::custom_free(u64 idx, bool deallocate)
{
	std::unique_lock<std::mutex> lock(*m_custom_registrer_mutex);
...
void espresso::mod::block::pass::log_info(const std::string& message)
{
...
void espresso::mod::block::pass::log_warning(const std::string& message)
{
	std::chrono::steady_clock::time_point now = std::chrono::steady_clock::now();
...
void espresso::mod::block::pass::log_error(const std::string& message, espresso::mod::block::pass::logger_fatality fatality)
{
	std::chrono::steady_clock::time_point now = std::chrono::steady_clock::now();
...
f64& espresso::mod::block::pass::get_real(u64 idx)
{
	return (this->*(m_get_real))(idx);
}

bool& espresso::mod::block::pass::get_bool(u64 idx)
{
	return (this->*(m_get_bool))(idx);
}

std::string& espresso::mod::block::pass::get_string(u64&& idx)
{
	return (this->*(m_get_string))(idx);
}

void* espresso::mod::block::pass::get_pre_data(u64 idx)
{
	return (this->*(m_get_pre_data))(idx);
}

const std::vector<std::string>& espresso::mod::block::pass::pull_messages_info()
{
	return m_messages_info;
}

const std::vector<std::string>& espresso::mod::block::pass::pull_messages_warn()
{
	return m_messages_warn;
}

const std::vector<std::string>& espresso::mod::block::pass::pull_messages_error()
{
	return m_messages_error;
}

void espresso::mod::block::pass::lock_messages()
{
	m_messages_mutex.lock();
}

void espresso::mod::block::pass::unlock_messages()
{
	m_messages_mutex.unlock();
}

void espresso::mod::block::pass::update_locations()
{
...
f64& espresso::mod::block::pass::get_real_debug(u64 idx)
{
...
f64& espresso::mod::block::pass::get_real_release(u64 idx)
{
	return m_active_real[m_active_idx[m_callstack_block_idx->back()][idx]];
}

bool& espresso::mod::block::pass::get_bool_debug(u64 idx)
{
...
bool& espresso::mod::block::pass::get_bool_release(u64 idx)
{
	return m_active_bool[m_active_idx[m_callstack_block_idx->back()][idx]];
}

std::string& espresso::mod::block::pass::get_string_debug(u64 idx)
{
...
std::string& espresso::mod::block::pass::get_string_release(u64 idx)
{
	return m_active_string[m_active_idx[m_callstack_block_idx->back()][idx]];
}

void* espresso::mod::block::pass::get_pre_data_debug(u64 idx)
{
...
void* espresso::mod::block::pass::get_pre_data_release(u64 idx)
{
