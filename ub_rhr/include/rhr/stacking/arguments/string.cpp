...
void rhr::stack::argument::string::ui_transform_update() { update_child_transform(m_text); }
...
void rhr::stack::argument::string::ui_update_buffers() { m_text->update_buffers(); }
