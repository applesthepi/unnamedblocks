...
void rhr::stack::argument::argument::set_data_compact(const std::string& data)
{
	...
	{
		cap::logger::error(cap::logger::level::EDITOR, __FILE__, __LINE__, "parsing error on data provided to the argument.");
		return;
	}

	if (!document.IsObject())
	{
		cap::logger::error(cap::logger::level::EDITOR, __FILE__, __LINE__, "data provided to the argument is not an object that can be parsed.");
		return;
	}
	...
	case 1:
		...
		break;
	default:
		cap::logger::error(cap::logger::level::EDITOR, __FILE__, __LINE__, "unknown cap::mod::block::block::argument::variable_mode index; using RAW instead");
		m_mode = cap::mod::block::block::argument::variable_mode::RAW;
		break;
	}
...
cap::mod::block::block::argument::variable_mode rhr::stack::argument::argument::get_mode() { return m_mode; }
...
cap::mod::block::block::argument::type rhr::stack::argument::argument::get_type() { return cap::mod::block::block::argument::type::TEXT; }

u32 rhr::stack::argument::argument::get_width() { return 50; }

bool rhr::stack::argument::argument::has_data() { return false; }
...
void rhr::stack::argument::argument::build_data_distribute()
{
	...
	case cap::mod::block::block::argument::variable_mode::VAR:
		...
		break;
	default:
		cap::logger::error(cap::logger::level::EDITOR, __FILE__, __LINE__, "unknown cap::mod::block::block::argument::variable_mode; using 0 instead");
		v_mode.SetInt(0);
		break;
	}
...
void rhr::stack::argument::argument::set_mode_restriction(cap::mod::block::block::argument::variable_mode_restriction mode_restriction) { m_mode_restriction = mode_restriction; }
