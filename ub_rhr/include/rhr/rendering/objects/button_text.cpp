...
rhr::render::object::button_text::button_text(const cap::color& primary_color, const cap::color& secondary_color, const std::string& text, glm::vec<2, i32>* plane_offset)
	: rhr::render::object::button(primary_color, secondary_color)
	, m_text(std::make_shared<rhr::render::object::text>(rhr::registry::char_texture::texture_type::BOLD_NORMAL, 4, true, false, plane_offset))
{
